  ...
  claude: {
    ...
    rows: [
      ...
      },
      {
        ...
        modelAlias: 'Claude Opus 4.1',
        input: { officialUsd: 15 },
        output: { officialUsd: 75 },
        cacheWrite: { officialUsd: 18.75 },
        cacheRead: { officialUsd: 1.5 },
      },
      {
        model: 'claude-opus-4',
        modelAlias: 'Claude Opus 4 (deprecated)',
        input: { officialUsd: 15 },
        output: { officialUsd: 75 },
        cacheWrite: { officialUsd: 18.75 },
        cacheRead: { officialUsd: 1.5 },
      ...
      },
      {
        ...
        modelAlias: 'Claude Sonnet 4 (deprecated)',
        input: { officialUsd: 3 },
        output: { officialUsd: 15 },
        cacheWrite: { officialUsd: 3.75 },
        cacheRead: { officialUsd: 0.3 },
      ...
      },
      {
        ...
        modelAlias: 'Claude Haiku 3.5 (retired)',
        input: { officialUsd: 0.8 },
        output: { officialUsd: 4 },
        cacheWrite: { officialUsd: 1.0 },
        cacheRead: { officialUsd: 0.08 },
      },
    ],
  },
  codex: {
    ...
    rows: [
      {
        model: 'gpt-5.5',
        modelAlias: 'OpenAI GPT-5.5',
        input: { officialUsd: 2.5 },
        output: { officialUsd: 15 },
        cacheRead: { officialUsd: 0.25 },
      },
      {
        model: 'gpt-5.4',
        modelAlias: 'OpenAI GPT-5.4',
        input: { officialUsd: 1.25 },
        output: { officialUsd: 7.5 },
        cacheRead: { officialUsd: 0.13 },
      },
      {
        model: 'gpt-5.4-mini',
        modelAlias: 'OpenAI GPT-5.4 Mini',
        input: { officialUsd: 0.375 },
        output: { officialUsd: 2.25 },
        cacheRead: { officialUsd: 0.0375 },
      },
      {
        model: 'gpt-5.4-nano',
        modelAlias: 'OpenAI GPT-5.4 Nano',
        input: { officialUsd: 0.10 },
        output: { officialUsd: 0.625 },
        cacheRead: { officialUsd: 0.01 },
      },
      {
        model: 'gpt-5.3-codex',
        modelAlias: 'GPT-5.3 Codex Standard',
      ...
      },
      {
        ...
        modelAlias: 'GPT-5.3 Codex Priority',
    ...
    rows: [
      {
        ...
        input: { officialUsd: 0.5 },
        output: { officialUsd: 3.0 },
        cacheRead: { officialUsd: 0.05 },
      },
      {
      ...
      },
      {
        ...
        modelAlias: 'Gemini 2.0 Flash (deprecated)',
        input: { officialUsd: 0.10 },
        output: { officialUsd: 0.40 },
        cacheRead: { officialUsd: 0.025 },
      },
      {
        model: 'gemini-2.0-flash-lite',
        modelAlias: 'Gemini 2.0 Flash Lite (deprecated)',
        input: { officialUsd: 0.075 },
        output: { officialUsd: 0.30 },
      },
    ],
  },
}
