            ...
            >
              ...
              <td class="px-4 py-2">
                <div class="max-w-[160px]">
                  <span
                    ...
                    :title="formatEndpointTooltip(log)"
                  >
              ...
              <td class="px-4 py-2">
                <div class="max-w-[160px]">
                  <template v-if="hasModelMapping(log)">
                    <span
                      class="flex items-center gap-1 truncate font-mono text-[11px] text-gray-700 dark:text-gray-300"
                      :title="modelMappingTooltip(log)"
                    >
              ...
              <td class="px-4 py-2">
                <span
                  ...
                  :title="t('admin.ops.errorLog.id') + ' ' + log.group_id"
                >
                  {{ log.group_name || '-' }}
                </span>
                <span v-else class="text-xs text-gray-400">-</span>
              ...
              <td class="px-4 py-2">
                <span
                  v-if="log.user_id"
                  class="block max-w-[140px] truncate text-xs font-medium text-gray-900 dark:text-gray-200"
                  :title="t('admin.ops.errorLog.userId') + ' ' + log.user_id"
                >
                  {{ log.user_email || '-' }}
                </span>
                <span v-else class="text-xs text-gray-400">-</span>
              ...
              <td class="px-4 py-2">
                <span
                  v-if="log.account_id"
                  class="block max-w-[120px] truncate text-xs font-medium text-gray-900 dark:text-gray-200"
                  :title="t('admin.ops.errorLog.accountId') + ' ' + log.account_id"
                >
                  {{ log.account_name || '-' }}
                </span>
                <span v-else class="text-xs text-gray-400">-</span>
